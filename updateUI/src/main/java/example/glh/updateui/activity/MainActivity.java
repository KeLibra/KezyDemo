...
public class MainActivity extends AppCompatActivity {
    ...
    private void requestVersion() {
         ...
         */
        VersionBean.DataBeanX.DataBean bean = new VersionBean.DataBeanX.DataBean();
       bean.setId("1234");
       bean.setName("测试apk");
       bean.setType("1");
       bean.setContent("更新了啊更新了");
       bean.setUrl("http://b.xzfile.com/apk2/freebiji_v1.00.01_downcc.com.apk");
        showUpdateDialog(MainActivity.this, bean);
