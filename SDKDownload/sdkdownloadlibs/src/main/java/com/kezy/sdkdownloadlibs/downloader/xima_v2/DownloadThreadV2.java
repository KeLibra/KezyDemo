...
import static com.kezy.sdkdownloadlibs.downloader.xima_v2.DownloadServiceV2.DOWNLOAD_ING;
import static com.kezy.sdkdownloadlibs.downloader.xima_v2.DownloadServiceV2.DOWN_ERROR;
import static com.kezy.sdkdownloadlibs.downloader.xima_v2.DownloadServiceV2.DOWN_OK;
import static com.kezy.sdkdownloadlibs.downloader.xima_v2.DownloadServiceV2.HANDLER_PAUSE;
import static com.kezy.sdkdownloadlibs.downloader.xima_v2.DownloadServiceV2.HANDLER_REMOVE;
import static com.kezy.sdkdownloadlibs.downloader.xima_v2.DownloadServiceV2.REQUEST_TIME_OUT;
 ...
 * @Description
 */
public class DownloadThreadV2 extends Thread{

    private DownloadInfo mTask;
    private final WeakReference<DownloadServiceV2.UpdateHandler> weakHandler;
    private final WeakReference<Context> weakContext;


    public DownloadThreadV2(Context context, DownloadInfo task, DownloadServiceV2.UpdateHandler handler) {
        this.mTask = task;
    ...
    public long downloadUpdateFile(Handler handler,final DownloadInfo task) throws IOException {
        ...
        try {
            ...
            if (TextUtils.isEmpty(task.path)) {
                ...
                task.path = path + "/" + DownloadServiceV2.DOWNLOAD_APK_PATH;
